  ...
  signMeUP() {
      if (formKey.currentState.validate()) {
        ...
        authMethods
          ...
          HelperFunctions.saveUserLoggedSharedPreference(false);
...
class exists extends StatefulWidget {
  @override
  _existsState createState() => _existsState();
}

class _existsState extends State<exists> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarMain(context),
      body: Center(
        child: Container(
          child: Text("User already exist. try again" ,style: simpleTextDeco()),),
        ),
      );
  }
}
